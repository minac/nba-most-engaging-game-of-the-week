...
class GameScorer:
    ...
    def score_game(
        ...
        score += top5_score
        breakdown["top5_teams"] = {"count": top5_count, "points": top5_score}
        ...
        score += close_score
        breakdown["close_game"] = {"margin": margin, "points": close_score}
        ...
        score += star_score
        breakdown["star_power"] = {"count": star_count, "points": star_score}

        # Criterion 5: Favorite team bonus
        has_favorite = False
        if favorite_team:
